...
<body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
    ...
    <nav id="scrollspy" class="navbar navbar-light bg-light navbar-expand-lg fixed-top" data-spy="affix" data-offset-top="20">
        <div class="container">
            <a class="navbar-brand" href="#"><img src="assets/imgs/huelogo0.svg" alt="" class="brand-img">
                <span style="color: #fff">Huelogic</span>
            </a>
    ...
    <header id="home" class="header">
        ...
        <div class="infos container mb-4 mb-md-2" style="visibility: visible;">
            <div class="title">
            ...
            <div class="socials text-right">
                <div class="row justify-content-between">
                    <div class="col">
                        ...
                        <a class="d-block subtitle"><i class="ti-email pr-2"></i> info@huelogic.in</a>
                    </div>
                    <div class="col">
